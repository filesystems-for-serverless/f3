...
COPY fuse/pfs /libfuse/pfs
COPY fuse/cxxopts.hpp fuse/f3.cc fuse/uds_client.cc fuse/libfuse/build/lib/libfuse3.a /libfuse/
RUN apt update && apt install -y build-essential
RUN g++ -Wall /libfuse/f3.cc /libfuse/uds_client.cc /libfuse/libfuse3.a /libfuse/pfs/lib/libpfs.a -I/libfuse/pfs/include -I/libfuse/faas/ -I/libfuse/include -o /libfuse/f3-fuse-driver -pthread -ldl -DHAVE_SETXATTR -g
